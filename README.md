...
N'ayant pas réussi à récupérer le fichier `/passwords.pdf` via la reconnaissance web, l'attaquant change de tactique. Il passe à l'offensif et cible directement un compte utilisateur du serveur FTP de Buttercup Games avec une attaque par brute force.
